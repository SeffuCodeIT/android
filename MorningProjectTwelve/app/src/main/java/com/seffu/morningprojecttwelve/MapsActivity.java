package com.seffu.morningprojecttwelve;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng emobilis = new LatLng(-1.2651213, 35.9387736);
        ...
        LatLng nakuru = new LatLng(-0.3158109, 36.798493);
        ...
        mMap.addMarker(new MarkerOptions().position(meru).title("Marker in nakuru"));
